...
class Auth extends ShieldAuth
{
     ...
     */
    // Após o login, o controller Home redireciona conforme o grupo do usuário.
     ...
     */
    // Registro público desabilitado. Usuários são criados exclusivamente pelo admin.
     ...
     * has been set up.
     */
    // Magic links desabilitados. Autenticação é exclusivamente via matrícula/senha (LDAP).
     ...
     */
    // Matrícula: alfanumérica, entre 3 e 20 caracteres.
     ...
     */
    // Login por matrícula (username). Email não é usado no SPIV.
    // Produção: autenticação via LDAP (LDAP_ENABLED=true); senha local usada apenas em dev.
     ...
     */
    // DictionaryValidator removido: produção usa LDAP; senhas locais são apenas para dev.
     ...
     */
    // Login feito por matrícula (username). Email não é usado no SPIV.
